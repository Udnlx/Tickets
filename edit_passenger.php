...
if ($id_passenger == '' || $edit_name_passenger == '' || $edit_birthday_passenger == '' || $edit_type_doc_passenger == '' || $edit_num_doc_passenger == '' || $edit_passport_passenger == '' || $edit_phone_passenger == '') {
    ...
    $log .= 'Старые значения: ' . $old_name_passenger . ' - ' . $old_birthday_passenger . ' - ' . $old_type_doc_passenger . ' - ' . $old_num_doc_passenger . ' - ' . $old_passport_passenger . ' - ' . $old_phone_passenger . '   ';
    $log .= 'Новые значения: ' . $edit_name_passenger . ' - ' . $edit_type_doc_passenger . ' - ' . $edit_num_doc_passenger . ' - ' . $edit_passport_passenger . ' - ' . $edit_phone_passenger;
