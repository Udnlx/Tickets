...
$edit_gender_passenger = $_POST['edit_gender_passenger'];
$edit_citizenship_passenger = $_POST['edit_citizenship_passenger'];
...
$old_name_passenger = $_POST['old_name_passenger'];
$old_gender_passenger = $_POST['old_gender_passenger'];
$old_citizenship_passenger = $_POST['old_citizenship_passenger'];
...
if ($id_passenger == '' || $edit_name_passenger == '' || $edit_gender_passenger == '' || $edit_citizenship_passenger == '' || $edit_birthday_passenger == '' || $edit_type_doc_passenger == '' || $edit_num_doc_passenger == '' || $edit_passport_passenger == '' || $edit_phone_passenger == '') {
    ...
    $log .= 'Старые значения: ' . $old_name_passenger . ' - ' . $old_gender_passenger . ' - ' . $old_citizenship_passenger . ' - ' . $old_birthday_passenger . ' - ' . $old_type_doc_passenger . ' - ' . $old_num_doc_passenger . ' - ' . $old_passport_passenger . ' - ' . $old_phone_passenger . '   ';
    $log .= 'Новые значения: ' . $edit_name_passenger . ' - ' . $edit_gender_passenger . ' - ' . $edit_citizenship_passenger . ' - ' . $edit_birthday_passenger . ' - ' . $edit_type_doc_passenger . ' - ' . $edit_num_doc_passenger . ' - ' . $edit_passport_passenger . ' - ' . $edit_phone_passenger;
    ...
    echo $edit_name_passenger . ' - ' . $edit_gender_passenger . ' - ' . $edit_citizenship_passenger . ' - ' . $edit_birthday_passenger . ' - ' . $edit_type_doc_passenger . ' - ' . $edit_num_doc_passenger . ' - ' . $edit_passport_passenger . ' - ' . $edit_phone_passenger;
    
    $edit_page = $pages->get('template=passengers, id=' . $id_passenger . '');
    $edit_page->of(false);
    $edit_page->title = $edit_name_passenger;
    $edit_page->name_passenger = $edit_name_passenger;
    $edit_page->gender_passenger = $edit_gender_passenger;
    $edit_page->citizenship_passenger = $edit_citizenship_passenger;
