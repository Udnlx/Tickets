	...
	<div class="uk-child-width-1-2@m" uk-grid>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-body uk-flex uk-flex-column">
                ...
                <form class="uk-flex uk-flex-column" id="print_select_seat" action="/otchet-po-reisu-dlia-storonnei-vedomosti/" method="post">
                    <div class="uk-margin-small-top uk-hidden">
                        <input class="uk-input" id="print_ved_selected_bus" type="text" name="print_ved_selected_bus" value="<?php echo $selected_bus; ?>">
                    </div>
                    <div class="uk-margin-small-top uk-hidden">
                        <input class="uk-input" id="print_ved_selected_id_bus" type="text" name="print_ved_selected_id_bus" value="<?php echo $selected_id_bus; ?>">
                    </div>
                    <div class="uk-margin-small-top uk-hidden">
                        <input class="uk-input" id="print_ved_selected_date" type="text" name="print_ved_selected_date" value="<?php echo $selected_date; ?>">
                    </div>
                    <div class="uk-margin-small-top uk-hidden">
                        <input class="uk-input" id="print_ved_selected_time" type="text" name="print_ved_selected_time" value="<?php echo $selected_time; ?>">
                    </div>
