...
$selected_bus = !empty($_POST['print_ved_selected_bus'])?$_POST['print_ved_selected_bus']:NULL;  
$selected_id_bus = !empty($_POST['print_ved_selected_id_bus'])?$_POST['print_ved_selected_id_bus']:NULL;
$selected_date = !empty($_POST['print_ved_selected_date'])?$_POST['print_ved_selected_date']:NULL;
$selected_time = !empty($_POST['print_ved_selected_time'])?$_POST['print_ved_selected_time']:NULL;
