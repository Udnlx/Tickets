...
<div id="content" style="max-width: 700px;">
	<h1 class="uk-heading-hero uk-text-center">Отчет по продаже комиссия за период</h1>
	...
	<div class="uk-child-width-1-2@m" uk-grid>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-body uk-flex uk-flex-column">
                ...
                <form class="uk-flex uk-flex-column" id="" action="/otchet-po-prodazhe-komissiia-za-period-pechat/" method="post">
